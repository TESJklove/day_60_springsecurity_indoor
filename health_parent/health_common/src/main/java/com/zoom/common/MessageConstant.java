...
public class MessageConstant {
    ...
    public static final String IMPORT_FAIL = "套餐数据导出失败";
    public static final String SYSTEM_EXCEPTION = "系统发生未知的异常请联系管理员";
    public static final String PAGE_SELECT_CHECKITEM_SUCCESS = "查询检查项成功";
    public static final String PAGE_SELECT_CHECKITEM_FAIL = "查询检查项失败";
    public static final String PAGE_SELECT_CHECKGROUP_SUCCESS = "查询检查组成功";
    public static final String PAGE_SELECT_CHECKGROUP_FAIL = "查询检查组失败";
    public static final String SELECT_CHECKITEMSID_BY_CHECKGROUP_SUCCESS = "根据检查组id查询关联的检查项id成功";
    public static final String SELECT_CHECKITEMSID_BY_CHECKGROUP_FAIL = "根据检查组id查询关联的检查项id失败";
    public static final String DELETE_CHECKITEM_SUCCESS = "删除检查组成功";
    public static final String DELETE_CHECKITEM_FAIL_BY_HAVE_CHILD_ITEM = "删除检查组失败，关联了检查项";
    public static final String DELETE_CHECKITEM_FAIL_BY_HAVE_PARENT_SETMEAL = "删除检查组失败，被检查套餐关联了";
    ...
    public static final String GET_ORDERSETTING_SUCCESS = "获取预约数据成功";
    public static final String GET_ORDERSETTING_FAIL = "获取预约数据失败";
    ...
    public static final String GET_CHECKGROUPIDS_BY_SETMEALID_SUCCESS = "查询套餐关联检查组成功";
    public static final String GET_CHECKGROUPIDS_BY_SETMEALID_FAIL = "查询套餐关联检查组失败";
